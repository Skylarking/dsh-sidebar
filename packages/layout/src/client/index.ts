...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    /** Plugin-owned right split surface inside the main workbench. */
    'shell.rightPanel': { kind: 'single'; scope: 'root'; owner: AuxiliaryPanelOwnerProps }
    /** Plugin-owned bottom split surface inside the main workbench. */
    'shell.bottomPanel': { kind: 'single'; scope: 'root'; owner: AuxiliaryPanelOwnerProps }
    /** Workspace actions shown over the official blank Session surface. */
...
/** Close affordance supplied by the layout owner to an auxiliary occupant. */
export interface AuxiliaryPanelOwnerProps {
  /** Close this split panel without knowing which plugin occupies it. */
  close: () => void
}
