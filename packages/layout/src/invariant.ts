/**
 * Package-owned invariant companion for `@skylarking/dsh-client-ui-workspace-layout`.
 * @module @skylarking/dsh-client-ui-workspace-layout/invariant
 */
...
const PACKAGE_NAME = '@skylarking/dsh-client-ui-workspace-layout'
